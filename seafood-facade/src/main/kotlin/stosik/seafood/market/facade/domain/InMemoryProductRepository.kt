...
internal class InMemoryProductRepository : ProductRepository {
    ...
    override fun findById(title: String) = productStore[title]

    override fun findAll(pageable: Pageable): Page<Product> = PageImpl<Product>(ArrayList<Product>(productStore.values),
            pageable, productStore.size.toLong())
}
